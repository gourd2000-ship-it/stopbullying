...
app.post('/api/chat', async (req, res) => {
  try {
    ...
    // Convert history to Gemini format and ensure alternating roles starting with 'user'
    let lastRole = null;
...
// Endpoint to generate summary at the end
...
`;
    ...
    // Extract JSON from the response (sometimes Gemini adds ```json ... ```)
